...
lista_1.insert(1, 5)    # adiciona um item (número 5) ao índice escolhido (índice 1).
...
lista_a = [2, 4, 6]
lista_b = [8, 10, 12]
lista_c = lista_a + lista_b     # concatenando as listas em uma nova variável.
lista_a.extend(lista_b)     # adiciona todos os elementos da lista_b na lista_a sem precisar criar uma variável.
print(lista_c)
print(lista_a, 'Nova lista A')
